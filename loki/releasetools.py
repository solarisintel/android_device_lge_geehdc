...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('set_metadata("/system/bin/loki.sh", "uid", 0, "gid", 2000, "mode", 0755, "capabilities", 0x0, "selabel", "u:object_r:hci_exec:s0");')
  info.script.AppendExtra('set_metadata("/system/bin/loki_tool", "uid", 0, "gid", 2000, "mode", 0755, "capabilities", 0x0, "selabel", "u:object_r:hci_exec:s0");')
